...
with pd.ExcelWriter("College_data.xlsx",engine="openpyxl") as writer:
    ...
    #Multiple sheets are created in an Excel file named "College_data.xlsx" with the student data written to a sheet named "Students" and the course data written to a sheet named "Courses". 